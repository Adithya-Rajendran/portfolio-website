...
- The approved artwork is `public/images/lunar-shared-horizon-v1.webp`: two distant figures sharing a view over a lunar settlement. The 3840 × 2160 delivery asset is resampled from a 1672 × 941 generated original; it is not native 4K detail. Large displays receive the full-quality asset directly, while smaller screens use responsive image optimization. Design explorations and artwork notes are in `design-previews/`.
