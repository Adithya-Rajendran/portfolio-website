...
export default function MobileToc({ headings }: { headings: PostHeading[] }) {
    ...
    return (
        ...
        >
            <details className="group os-card-flat rounded-card px-5 py-4">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400 [&::-webkit-details-marker]:hidden">
                    On this page
                    <ChevronDown
                        aria-hidden
                ...
                <ul className="mt-4 space-y-2.5 text-sm border-t border-slate-200/60 dark:border-white/8 pt-4">
