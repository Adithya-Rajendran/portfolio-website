    ...
    return (
        ...
        >
            ...
            <p className="mb-3 text-slate-700 dark:text-slate-300">
                ...
                <span className="font-medium text-slate-900 dark:text-emerald-400">
                    University of California, Santa Cruz
                </span>
                , I've been advancing my career in cloud engineering and cybersecurity. 
                In my current role as a{" "}
                <span className="font-medium text-slate-900 dark:text-emerald-400">Cloud Field Engineer</span>, I focus on deploying 
                scalable infrastructure solutions using technologies like{" "}
                <span className="font-medium text-slate-900 dark:text-cyan-400">Kubernetes</span>,{" "}
                <span className="font-medium text-slate-900 dark:text-cyan-400">OpenStack</span>, and{" "}
                <span className="font-medium text-slate-900 dark:text-cyan-400">Ubuntu</span>. My work involves optimizing 
