...
export default function Certification(cert: CertificateType) {
    ...
    return (
        ...
        >
            <section className="bg-slate-50 max-w-[42rem] border border-slate-200 rounded-lg overflow-hidden sm:pr-8 relative hover:bg-slate-100 transition dark:text-slate-200 dark:bg-white/[0.03] dark:border-white/8 dark:hover:bg-white/[0.06] flex justify-between">
